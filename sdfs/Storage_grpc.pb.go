...
type StorageServiceClient interface {
	...
	WriteChunksStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_WriteChunksStreamClient, error)
...
func (c *storageServiceClient) WriteChunksStream(ctx context.Context, opts ...grpc.CallOption) (StorageService_WriteChunksStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[0], "/org.opendedup.grpc.StorageService/WriteChunksStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &storageServiceWriteChunksStreamClient{stream}
	return x, nil
}

type StorageService_WriteChunksStreamClient interface {
	Send(*WriteChunksRequest) error
	CloseAndRecv() (*WriteChunksResponse, error)
	grpc.ClientStream
}

type storageServiceWriteChunksStreamClient struct {
	grpc.ClientStream
}

func (x *storageServiceWriteChunksStreamClient) Send(m *WriteChunksRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *storageServiceWriteChunksStreamClient) CloseAndRecv() (*WriteChunksResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(WriteChunksResponse)
...
func (c *storageServiceClient) GetChunks(ctx context.Context, in *GetChunksRequest, opts ...grpc.CallOption) (StorageService_GetChunksClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[1], "/org.opendedup.grpc.StorageService/GetChunks", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageServiceClient) SubscribeToVolume(ctx context.Context, in *VolumeEventListenRequest, opts ...grpc.CallOption) (StorageService_SubscribeToVolumeClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[2], "/org.opendedup.grpc.StorageService/SubscribeToVolume", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageServiceClient) GetSparseDedupeFile(ctx context.Context, in *SparseDedupeFileRequest, opts ...grpc.CallOption) (StorageService_GetSparseDedupeFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[3], "/org.opendedup.grpc.StorageService/GetSparseDedupeFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageServiceClient) ListReplLogs(ctx context.Context, in *VolumeEventListenRequest, opts ...grpc.CallOption) (StorageService_ListReplLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &StorageService_ServiceDesc.Streams[4], "/org.opendedup.grpc.StorageService/ListReplLogs", opts...)
	if err != nil {
		return nil, err
	}
...
type StorageServiceServer interface {
	...
	WriteChunksStream(StorageService_WriteChunksStreamServer) error
...
func (UnimplementedStorageServiceServer) WriteChunksStream(StorageService_WriteChunksStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method WriteChunksStream not implemented")
}
...
func _StorageService_WriteChunksStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServiceServer).WriteChunksStream(&storageServiceWriteChunksStreamServer{stream})
}

type StorageService_WriteChunksStreamServer interface {
	SendAndClose(*WriteChunksResponse) error
	Recv() (*WriteChunksRequest, error)
	grpc.ServerStream
}

type storageServiceWriteChunksStreamServer struct {
	grpc.ServerStream
}

func (x *storageServiceWriteChunksStreamServer) SendAndClose(m *WriteChunksResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *storageServiceWriteChunksStreamServer) Recv() (*WriteChunksRequest, error) {
	m := new(WriteChunksRequest)
...
var StorageService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "WriteChunksStream",
			Handler:       _StorageService_WriteChunksStream_Handler,
			ClientStreams: true,
		},
		{
